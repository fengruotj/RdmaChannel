...
/**
 * DISNI Benchmark SendRecvClient 客户端程序
 * java -cp disni-1.6-jar-with-dependencies.jar:disni-1.6-tests.jar com.ibm.disni.benchmarks.SendRecvClient -a 10.10.0.25 -s 64 -k 1000000
 */
